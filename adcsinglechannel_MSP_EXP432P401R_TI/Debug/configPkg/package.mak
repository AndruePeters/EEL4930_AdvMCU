...
.dlls,em4f .dlls: adcsinglechannel.pem4f

-include package/cfg/adcsinglechannel_pem4f.mak
-include package/cfg/adcsinglechannel_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/adcsinglechannel_pem4f.dep
endif
adcsinglechannel.pem4f: package/cfg/adcsinglechannel_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
adcsinglechannel.pem4f package/cfg/adcsinglechannel_pem4f.c: .libraries,em4f
endif

package/cfg/adcsinglechannel_pem4f.c package/cfg/adcsinglechannel_pem4f.h package/cfg/adcsinglechannel_pem4f.xdl: override _PROG_NAME := adcsinglechannel.xem4f
package/cfg/adcsinglechannel_pem4f.c: package/cfg/adcsinglechannel_pem4f.cfg
package/cfg/adcsinglechannel_pem4f.xdc.inc: package/cfg/adcsinglechannel_pem4f.xdl
package/cfg/adcsinglechannel_pem4f.xdl package/cfg/adcsinglechannel_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/adcsinglechannel_pem4f.cfg
	-$(RM) package/cfg/adcsinglechannel_pem4f.dep
	-$(RM) package/cfg/adcsinglechannel_pem4f.c
	-$(RM) package/cfg/adcsinglechannel_pem4f.xdc.inc

clean,em4f::
	-$(RM) adcsinglechannel.pem4f
.executables,em4f .executables: adcsinglechannel.xem4f

adcsinglechannel.xem4f: |adcsinglechannel.pem4f

-include package/cfg/adcsinglechannel.xem4f.mak
adcsinglechannel.xem4f: package/cfg/adcsinglechannel_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/adcsinglechannel_pem4f.oem4f   package/cfg/adcsinglechannel_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
adcsinglechannel.xem4f: export C_DIR=
adcsinglechannel.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
adcsinglechannel.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

adcsinglechannel.test test,em4f test: adcsinglechannel.xem4f.test

adcsinglechannel.xem4f.test:: adcsinglechannel.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 adcsinglechannel.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.adcsinglechannel.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,adcsinglechannel.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) adcsinglechannel.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
adcsinglechannel_pem4f.oem4f,copy : package/cfg/adcsinglechannel_pem4f.oem4f
adcsinglechannel_pem4f.sem4f,copy : package/cfg/adcsinglechannel_pem4f.sem4f
