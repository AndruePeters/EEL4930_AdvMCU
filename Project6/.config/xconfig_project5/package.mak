...
override PKGDIR = xconfig_project5
...
package/%.xdc.inc package/%_xconfig_project5.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_project5" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: project5.pem4f

-include package/cfg/project5_pem4f.mak
-include package/cfg/project5_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/project5_pem4f.dep
endif
project5.pem4f: package/cfg/project5_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
project5.pem4f package/cfg/project5_pem4f.c: .libraries,em4f
endif

package/cfg/project5_pem4f.c package/cfg/project5_pem4f.h package/cfg/project5_pem4f.xdl: override _PROG_NAME := project5.xem4f
package/cfg/project5_pem4f.c: package/cfg/project5_pem4f.cfg
package/cfg/project5_pem4f.xdc.inc: package/cfg/project5_pem4f.xdl
package/cfg/project5_pem4f.xdl package/cfg/project5_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/project5_pem4f.cfg
	-$(RM) package/cfg/project5_pem4f.dep
	-$(RM) package/cfg/project5_pem4f.c
	-$(RM) package/cfg/project5_pem4f.xdc.inc

clean,em4f::
	-$(RM) project5.pem4f
.executables,em4f .executables: project5.xem4f

project5.xem4f: |project5.pem4f

-include package/cfg/project5.xem4f.mak
project5.xem4f: package/cfg/project5_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/project5_pem4f.oem4f   package/cfg/project5_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
project5.xem4f: export C_DIR=
project5.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
project5.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

project5.test test,em4f test: project5.xem4f.test

project5.xem4f.test:: project5.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 project5.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.project5.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,project5.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
project5_pem4f.oem4f,copy : package/cfg/project5_pem4f.oem4f
project5_pem4f.sem4f,copy : package/cfg/project5_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_project5
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_project5.tar.dep
endif
package/rel/xconfig_project5/xconfig_project5/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_project5/xconfig_project5/package/package.rel.xml: package/build.cfg
package/rel/xconfig_project5/xconfig_project5/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_project5/xconfig_project5/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_project5.tar: package/rel/xconfig_project5.xdc.inc package/rel/xconfig_project5/xconfig_project5/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_project5.xdc.inc,package/rel/xconfig_project5.tar.dep)


release release,xconfig_project5: all xconfig_project5.tar
clean:: .clean
	-$(RM) xconfig_project5.tar
	-$(RM) package/rel/xconfig_project5.xdc.inc
	-$(RM) package/rel/xconfig_project5.tar.dep
