...
linker.cmd: package/cfg/project6_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/project6_pem4fcfg.cmd\)\"$""\"/Users/druepeters/Documents/Development/EEL4930_AdvMCU/project6_alt/.config/xconfig_project6/\1\""' package/cfg/project6_pem4f.xdl > $@
