...
/*                          Global Mutables                                   */
/******************************************************************************/
volatile bool   GameState = 0;
volatile uint32_t quizScore = 0;
Question questions[10];
volatile uint32_t currQ = 0;
...
volatile unsigned jsDebounce = 0;
volatile int jsDirection = 0; // 0 is don't move, 1 is move up, -1 is move down

// used to control SysTick
volatile bool buzzerSysTickInterrupt = 0;
volatile bool jsSysTickInterrupt = 0;

// used to keep track of current selection
